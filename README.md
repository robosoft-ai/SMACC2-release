...
The packages in the `smacc2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release smacc2 --rosdistro jazzy --track jazzy --unsafe` on `Thu, 11 Jun 2026 23:08:55 -0000`
...
- upstream repository: https://github.com/robosoft-ai/SMACC2.git
- release repository: https://github.com/robosoft-ai/SMACC2-release.git
- rosdistro version: `2.3.18-1`
- old version: `2.3.20-1`
- new version: `2.3.20-2`
...
## smacc2 (humble) - 2.3.20-1

The packages in the `smacc2` repository were released into the `humble` distro by running `/home/brettpac/.local/bin/bloom-release smacc2 --rosdistro humble --track humble` on `Sat, 01 Nov 2025 10:58:36 -0000`
...
- release repository: https://github.com/robosoft-ai/SMACC2-release.git
- rosdistro version: `2.3.18-1`
- old version: `2.3.18-1`
- new version: `2.3.20-1`
